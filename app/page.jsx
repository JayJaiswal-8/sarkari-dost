...
const SCHEMES_DATA = [
  ...
  },
  {
    ...
    benefit: "Low-interest loans up to ₹10 Lakhs for higher education.",
  ...
  },
  {
    id: 3,
    name: "Ujjwala Yojana",
    benefit: "Free LPG connection for women from BPL families.",
  ...
  },
  {
    ...
    benefit: "Financial assistance for the girl child's education and health.",
  ...
  },
  {
    ...
    benefit: "Merit-based scholarships for students across India.",
            ...
            <div className="max-w-2xl w-full bg-white/5 backdrop-blur-2xl p-8 md:p-16 rounded-[50px] border border-white/10 shadow-2xl">
              ...
              <form onSubmit={handleAnalyze} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="relative">
                  ...
                  <input placeholder="State" required className="w-full pl-12 p-4 rounded-2xl bg-white/5 border border-white/10 focus:border-blue-500 outline-none text-white" onChange={e => setFormData({...formData, state: e.target.value})} />
                </div>
                <div className="relative">
                  <User className="absolute left-4 top-4 text-slate-500" size={20} />
                  <input placeholder="Age" type="number" required className="w-full pl-12 p-4 rounded-2xl bg-white/5 border border-white/10 focus:border-blue-500 outline-none text-white" onChange={e => setFormData({...formData, age: e.target.value})} />
                </div>
                <div className="relative">
                  <Wallet className="absolute left-4 top-4 text-slate-500" size={20} />
                  <input placeholder="Annual Income (₹)" type="number" required className="w-full pl-12 p-4 rounded-2xl bg-white/5 border border-white/10 focus:border-blue-500 outline-none text-white" onChange={e => setFormData({...formData, income: e.target.value})} />
                </div>
                <div className="relative">
                  <GraduationCap className="absolute left-4 top-4 text-slate-500" size={20} />
                  <input placeholder="Category (SC/ST/OBC/Gen)" required className="w-full pl-12 p-4 rounded-2xl bg-white/5 border border-white/10 focus:border-blue-500 outline-none text-white" onChange={e => setFormData({...formData, category: e.target.value})} />
                </div>
                <div className="relative md:col-span-2">
                  <Briefcase className="absolute left-4 top-4 text-slate-500" size={20} />
                  <input placeholder="Profession (e.g. Farmer, Student)" required className="w-full pl-12 p-4 rounded-2xl bg-white/5 border border-white/10 focus:border-blue-500 outline-none text-white" onChange={e => setFormData({...formData, profession: e.target.value})} />
                </div>
                <button className="md:col-span-2 bg-blue-600 text-white py-5 rounded-2xl font-black text-xl hover:bg-blue-700 transition-all shadow-xl">
                  Analyze My Profile →
                </button>
              </form>
            </div>
